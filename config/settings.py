...
SECRET_KEY = 'django-insecure-ik_nb#+z=og*#ork++c1v@qun+q60_y(iep76r95%5=5hq4^4m'
...
CERT_FILE = os.path.join(BASE_DIR, 'client2024test.cer')
KEY_FILE = os.path.join(BASE_DIR, 'client2024test.key')
